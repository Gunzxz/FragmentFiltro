...
public class MainActivity2 extends AppCompatActivity {
    ...
    TextView text;
       ...
       public MainActivity2(String nombreUsuario, String nombreProyecto, String nombrePais) {
    ...
    ArrayList<MainActivity2> listaUsuario;
    ArrayList<MainActivity2> listaProyecto;
    ArrayList<MainActivity2> listaPais;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (c2.getCount() == 0) {
            ...
            bbdd.execSQL("INSERT INTO \"main\".\"datos\" (\"dato\", \"columna\", \"fila\") VALUES ('1/8', '7', '1/1000');\n");
            ...
            bbdd.execSQL("INSERT INTO \"main\".\"datos\" (\"dato\", \"columna\", \"fila\") VALUES ('128\"', '7', '1\"');\n");
            ...
            bbdd.execSQL("INSERT INTO \"main\".\"datos\" (\"dato\", \"columna\", \"fila\") VALUES ('128\"', '8', '1/2');\n");
            ...
            bbdd.execSQL("INSERT INTO \"main\".\"datos\" (\"dato\", \"columna\", \"fila\") VALUES ('128\"', '9', '1/4');\n");
            ...
            bbdd.execSQL("INSERT INTO \"main\".\"datos\" (\"dato\", \"columna\", \"fila\") VALUES ('128\"', '10', '1/8');\n");
            ...
            bbdd.execSQL("INSERT INTO \"main\".\"datos\" (\"dato\", \"columna\", \"fila\") VALUES ('128\"', '15', '1/250');\n");
            ...
            bbdd.execSQL("INSERT INTO \"main\".\"datos\" (\"dato\", \"columna\", \"fila\") VALUES ('34''8\"', '15', '1/15');\n");
            bbdd.execSQL("INSERT INTO \"main\".\"datos\" (\"dato\", \"columna\", \"fila\") VALUES ('68''16\"', '15', '1/8');\n");
            ...
            bbdd.execSQL("INSERT INTO \"main\".\"datos\" (\"dato\", \"columna\", \"fila\") VALUES ('546''8\"', '15', '1\"');\n");
            ...
            bbdd.execSQL("INSERT INTO \"main\".\"datos\" (\"dato\", \"columna\", \"fila\") VALUES ('8533''20\"', '20', '1/2');\n");
